...
컷신 화면에 들어가자마자 재생 시작, 장을 넘기거나 되돌아가도 끊기지 않고
계속 반복 재생됨 (배경 테스트 씬으로 넘어가면 자연스럽게 멈춤).

넣은 뒤 Unity에서 "Tools > Class Template > Add Background Music To Intro
Cutscene Scene"을 실행하면 자동으로 연결됨.
