...
파일명 (정확히 이 이름으로, 소문자로만):
  monsterc_attack1   공격 1
  monsterc_attack2   공격 2
  monsterc_hit       맞았을 때
  monsterc_death     죽었을 때
...
넣은 뒤 Unity에서 아래를 순서대로 실행할 것.
  1) Tools > Class Template > Wire MonsterC SFX Clips
  2) Tools > Class Template > Apply Monster C Settings To Prefab
