...
파일명 (정확히 이 이름으로, 소문자로만):
  monstera_attack    공격
  monstera_hit       맞았을 때
  monstera_death     죽었을 때

몬스터A는 공격이 하나뿐이라 효과음도 3개입니다 (B와 C는 4개).
...
넣은 뒤 Unity에서 아래를 순서대로 실행할 것.
  1) Tools > Class Template > Wire MonsterA SFX Clips
  2) Tools > Class Template > Apply Monster A Settings To Prefab
