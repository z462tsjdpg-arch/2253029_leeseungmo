Stage3 몬스터1 효과음 넣는 곳 (심화 - 스테이지 확장)
...
★ 스테이지1과 파일명 규칙이 다릅니다
  스테이지1은 monstera_attack 처럼 접두사가 붙지만, 확장 스테이지는
  폴더 이름(Stage3Monster1)이 이미 구분해주므로 attack 처럼 짧게 씁니다.

몬스터1은 몬스터A와 같은 행동을 재사용하므로 공격이 하나뿐입니다.
확장자는 자유 (wav / mp3 / ogg 다 됨).

넣은 뒤 스테이지 확장 도구에서 "몬스터 프리팹 3개 만들기/다시 반영"을
누르면 자동으로 연결됩니다.
