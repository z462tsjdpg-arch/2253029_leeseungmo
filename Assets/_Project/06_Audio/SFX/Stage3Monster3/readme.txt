Stage3 몬스터3 효과음 넣는 곳 (심화 - 스테이지 확장)
...
★ 스테이지1과 파일명 규칙이 다릅니다
  스테이지1은 monsterc_attack1 처럼 접두사가 붙지만, 확장 스테이지는
  폴더 이름(Stage3Monster3)이 이미 구분해주므로 attack1 처럼 짧게 씁니다.

몬스터3은 몬스터C와 같은 행동을 재사용합니다.
